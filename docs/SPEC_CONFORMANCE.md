...
| E11 | Supply-chain gates: [`audit.toml`](../.cargo/audit.toml), [`Cargo.lock`](../Cargo.lock), [`.gitleaks.toml`](../.gitleaks.toml), [`deny.toml`](../deny.toml), [`scan-images.sh`](../infra/security/scan-images.sh), the `rustsec/audit-check`, `gitleaks`, `cargo-deny`, and trivy CI steps, and the Dependency Policy in [`SECURITY.md`](../SECURITY.md) |
