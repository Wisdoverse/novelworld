...
| E11 | Supply-chain gates: [`audit.toml`](../.cargo/audit.toml), [`Cargo.lock`](../Cargo.lock), [`.gitleaks.toml`](../.gitleaks.toml), [`deny.toml`](../deny.toml), the `rustsec/audit-check`, `gitleaks`, and `cargo-deny` CI steps, and the Dependency Policy in [`SECURITY.md`](../SECURITY.md) |
