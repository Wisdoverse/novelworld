...
| E11 | Supply-chain gates: [`audit.toml`](../.cargo/audit.toml), [`Cargo.lock`](../Cargo.lock), [`.gitleaks.toml`](../.gitleaks.toml), the `rustsec/audit-check` and `gitleaks` CI steps, and the Dependency Policy in [`SECURITY.md`](../SECURITY.md) |
