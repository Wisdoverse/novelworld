...
| §6.1 — complete persona, world, progress, identity, and deviation prompt | Intended gap | H3 | E0, E3; the persona slice now flows from the extracted fields (aliases, role, description, personality, background, speaking style) as quoted inert data ([PR #143](https://github.com/Wisdoverse/novelworld/pull/143)); world/identity/deviation completeness and live quality remain gap |
