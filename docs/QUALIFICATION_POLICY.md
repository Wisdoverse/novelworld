...
| [DeepSeek v4 Flash live baseline](./evidence/deepseek-v4-flash-live-baseline.json) | At exact code SHA `c13ffd9f9904c36ed3f7abf01d7d66160b7f15bd`, an isolated production-Compose reader journey completed and H3 passed 24/24 live calibration samples | H1 failed 5/6 slices, human quality approval is absent, and no qualification claim is made |
...
| Character/world quality | Human-calibrated live conversation and trajectory cases | Character fidelity, memory relevance, multi-turn and causal coherence meet the approved rubric | DeepSeek v4 Flash completed the product baseline and passed H3's 24/24 same-provider calibration; human approval and H4 release-upgrade/accessibility evidence remain absent |
