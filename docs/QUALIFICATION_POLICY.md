...
| [`h1-extraction-v1`](../tools/h1-eval/README.md) | Import-success gates on the production extractor/splitter for the zh/en TXT slices (UTF-8, GBK, BOM UTF-16) with labeled malformed/unsupported negatives, plus `extraction-quality-v1` rubric calibration | Recorded structural evidence does not qualify a provider/model; live scoring is a separate slice |
