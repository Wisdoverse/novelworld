...
| Character/world quality | Human-calibrated live conversation and trajectory cases | Character fidelity, memory relevance, multi-turn and causal coherence meet the approved rubric | DeepSeek v4 Flash completed the product baseline and passed the final-SHA H3 24/24 same-provider calibration; an earlier failed multi-turn sample remains retained as variance, while human approval and H4 release-upgrade/accessibility evidence remain absent |
