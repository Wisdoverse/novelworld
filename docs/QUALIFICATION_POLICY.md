...
proves an empty project, cold-adopts the base without provider settings, verifies
...
this phase writes no report and removes only resources labelled for that project;
