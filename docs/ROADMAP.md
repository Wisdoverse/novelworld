...
| Quality and scale were completed | One DeepSeek live product/H1/H3 baseline now exists: the product journey completed, but H1 and H3 fail, human approval is absent, and capacity evidence remains a test-only single-node profile | H3–H6 |
