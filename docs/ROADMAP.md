...
| 5 — Measured scale | In progress | [Issue #101](https://github.com/schorsch888/novelworld/issues/101) establishes the versioned `single-node-v1` SLO and capacity gate before any scaling infrastructure is considered. |
