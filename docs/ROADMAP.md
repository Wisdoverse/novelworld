...
|---|---|---|
| Character personality and voice drive chat | Novel service stores persona fields; the Agent boundary now carries source-backed persona (aliases, role, description, personality, background, speaking style) into the system prompt as quoted inert data ([PR #143](https://github.com/Wisdoverse/novelworld/pull/143)); live quality remains unqualified | H3 |
