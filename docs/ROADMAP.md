...
| Quality and scale were completed | One DeepSeek live product/H3 baseline now exists, but H1 fails, human approval is absent, and capacity evidence remains a test-only single-node profile | H3–H6 |
