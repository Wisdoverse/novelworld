...
| Quality and scale were completed | One DeepSeek live product/H1/H3 baseline now exists: the product journey and H3 calibration passed, but H1 fails, human approval is absent, and capacity evidence remains a test-only single-node profile | H3–H6 |
