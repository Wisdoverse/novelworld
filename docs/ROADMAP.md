...
| 4 — Living open world | In progress | [Issue #99](https://github.com/schorsch888/novelworld/issues/99) tracks the single-timeline implementation; merge under required CI remains the completion gate. |
