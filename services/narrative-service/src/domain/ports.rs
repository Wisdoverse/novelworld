use crate::domain::entities::game_rules::{ActionAdjudicationContext, AdjudicationDecision};
...
/// Classifies an authorized action; code maps and freezes the bounded decision.
#[async_trait]
pub trait ActionAdjudicationPort: Send + Sync {
    async fn adjudicate(
        &self,
